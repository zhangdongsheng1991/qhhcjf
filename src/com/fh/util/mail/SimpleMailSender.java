  ...
  */    
    ...
    public static void main(String[] args) throws Exception{   
        //这个类主要是设置邮件   
	     ...
	     mailInfo.setValidate(true);    
	     mailInfo.setUserName("360940982@qq.com");    
	     mailInfo.setPassword("gvsqpwesicxzbiee");//您的邮箱密码    
	     mailInfo.setFromAddress("360940982@qq.com");    
	     mailInfo.setToAddress("1257182595@qq.com");    
	     mailInfo.setSubject("设置邮箱标题");    
	     mailInfo.setContent("设置邮箱内容");    
	     //这个类主要来发送邮件   
	  sendEmail("smtp.qq.com", "465", "1257182595@qq.com", "19910619'",
			  "360940982@qq.com", "hh", "呵呵","1");
	     SimpleMailSender sms = new SimpleMailSender();   
