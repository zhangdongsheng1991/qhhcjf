/*! jQuery JavaScript Library v1.9.1 | Copyright 2005, 2012 jQuery Foundation, Inc. and other contributors | Released under the MIT license */
!function(a, b) {
    function I(a) {
        var b = a.length
          , c = t.type(a);
    ...
    function N(a, c, d, e) {
        if (t.acceptData(a)) {
            ...
            if (m && l[m] && (e || l[m].data) || !i || d !== b)
                return m || (j ? a[h] = m = k.pop() || t.guid++ : m = h),
                l[m] || (l[m] = {},
                j || (l[m].toJSON = t.noop)),
                ("object" == typeof c || "function" == typeof c) && (e ? l[m] = t.extend(l[m], c) : l[m].data = t.extend(l[m].data, c)),
                f = l[m],
                e || (f.data || (f.data = {}),
                f = f.data),
                d !== b && (f[t.camelCase(c)] = d),
                i ? (g = f[c],
                null == g && (g = f[t.camelCase(c)])) : g = f,
                g
        }
    }
    function O(a, b, c) {
        if (t.acceptData(a)) {
            ...
            if (h[i]) {
                if (b && (f = c ? h[i] : h[i].data)) {
                    ...
                    e = b.length; e > d; d++)
                        delete f[b[d]];
                    if (!(c ? Q : t.isEmptyObject)(f))
                        return
                }
                (c || (delete h[i].data,
                Q(h[i]))) && (g ? t.cleanData([a], !0) : t.support.deleteExpando || h != h.window ? delete h[i] : h[i] = null)
            }
        }
    }
    function P(a, c, d) {
    ...
    function Q(a) {
        var b;
        for (b in a)
            if (("data" !== b || !t.isEmptyObject(a[b])) && "toJSON" !== b)
                return !1;
        return !0
    }
    function eb() {
    ...
    function Kb(a, b) {
        ...
        if (1 === b.nodeType) {
            ...
            !t.support.noCloneEvent && b[t.expando]) {
                e = t._data(b);
                for (d in e.events)
                    t.removeEvent(b, d, e.handle);
                b.removeAttribute(t.expando)
            }
            "script" === c && b.text !== a.text ? (Gb(b).text = a.text,
            Hb(b)) : "object" === c ? (b.parentNode && (b.outerHTML = a.outerHTML),
    ...
    function dc(a, b) {
        for (var c, d, e, f = [], g = 0, h = a.length; h > g; g++)
            d = a[g],
            d.style && (f[g] = t._data(d, "olddisplay"),
            c = d.style.display,
            b ? (f[g] || "none" !== c || (d.style.display = ""),
            "" === d.style.display && cc(d) && (f[g] = t._data(d, "olddisplay", hc(d.nodeName)))) : f[g] || (e = cc(d),
    ...
    function fc(a, b, c, d, e) {
        for (var f = c === (d ? "border" : "content") ? 4 : "width" === b ? 1 : 0, g = 0; 4 > f; f += 2)
            "margin" === c && (g += t.css(a, c + _b[f], !0, e)),
            d ? ("content" === c && (g -= t.css(a, "padding" + _b[f], !0, e)),
    ...
    function gc(a, b, c) {
        ...
        if (0 >= e || null == e) {
            ...
            Wb.test(e))
                return e;
            d = g && (t.support.boxSizingReliable || e === a.style[b]),
            e = parseFloat(e) || 0
        }
    ...
    function hc(a) {
        var b = f
          , c = Yb[a];
        return c || (c = ic(a, b),
        "none" !== c && c || (Nb = (Nb || t("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(b.documentElement),
    ...
    function oc(a, b, c, d) {
        var e;
        if (t.isArray(b))
            t.each(b, function(b, e) {
                c || kc.test(a) ? d(a, e) : oc(a + "[" + ("object" == typeof e ? b : "") + "]", e, c, d)
            });
        else if (c || "object" !== t.type(b))
            d(a, b);
        else
            for (e in b)
                oc(a + "[" + e + "]", b[e], c, d)
    ...
    function _c(a, b, c) {
        var d, e, f = 0, g = Xc.length, h = t.Deferred().always(function() {
            ...
            if (e)
                return !1;
            for (var b = Sc || Zc(), c = Math.max(0, j.startTime + j.duration - b), d = c / j.duration || 0, f = 1 - d, g = 0, i = j.tweens.length; i > g; g++)
                j.tweens[g].run(f);
        ...
        for (ad(k, j.opts.specialEasing); g > f; f++)
            if (d = Xc[f].call(j, a, k, j.opts))
                return d;
        return $c(j, k),
        t.isFunction(j.opts.start) && j.opts.start.call(a, j),
        t.fx.timer(t.extend(i, {
            elem: a,
            anim: j,
            queue: j.opts.queue
        })),
    ...
    function bd(a, b, c) {
        ...
        m.always(function() {
            m.always(function() {
                k.unqueued--,
                t.queue(a, "fx").length || k.empty.fire()
            })
        })),
        ...
        t.support.shrinkWrapBlocks || m.always(function() {
        ...
        if (f = p.length) {
            h = t._data(a, "fxshow") || t._data(a, "fxshow", {}),
            "hidden"in h && (q = h.hidden),
            i && (h.hidden = !q),
            q ? t(a).show() : m.done(function() {
                t(a).hide()
            }),
            m.done(function() {
                var b;
    ...
    var c, d, e = typeof b, f = a.document, g = a.location, h = a.jQuery, i = a.$, j = {}, k = [], l = "1.9.1", m = k.concat, n = k.push, o = k.slice, p = k.indexOf, q = j.toString, r = j.hasOwnProperty, s = l.trim, t = function(a, b) {
        ...
        f.addEventListener ? (f.removeEventListener("DOMContentLoaded", G, !1),
        a.removeEventListener("load", G, !1)) : (f.detachEvent("onreadystatechange", G),
    ...
    t.fn = t.prototype = {
        ...
        init: function(a, c, d) {
            ...
            if ("string" == typeof a) {
                ...
                if (e[1]) {
                    if (c = c instanceof t ? c[0] : c,
                    t.merge(this, t.parseHTML(e[1], c && c.nodeType ? c.ownerDocument || c : f, !0)),
                    y.test(e[1]) && t.isPlainObject(c))
                        for (e in c)
                            t.isFunction(this[e]) ? this[e](c[e]) : this.attr(e, c[e]);
                    return this
                }
                if (g = f.getElementById(e[2]),
                g && g.parentNode) {
                    if (g.id !== e[2])
                        return d.find(a);
                    this.length = 1,
            ...
            this.length = 1,
            this) : t.isFunction(a) ? d.ready(a) : (a.selector !== b && (this.selector = a.selector,
    ...
    t.extend = t.fn.extend = function() {
        ...
        h = arguments[1] || {},
        i = 2),
        "object" == typeof h || t.isFunction(h) || (h = {}),
        j === i && (h = this,
        --i); j > i; i++)
            if (null != (f = arguments[i]))
                for (e in f)
                    a = h[e],
                    d = f[e],
                    h !== d && (k && d && (t.isPlainObject(d) || (c = t.isArray(d))) ? (c ? (c = !1,
                    g = a && t.isArray(a) ? a : []) : g = a && t.isPlainObject(a) ? a : {},
                    h[e] = t.extend(k, g, d)) : d !== b && (h[e] = d));
        return h
    }
    ,
    t.extend({
        ...
        ready: function(a) {
            if (a === !0 ? !--t.readyWait : !t.isReady) {
                ...
                t.isReady = !0,
                a !== !0 && --t.readyWait > 0 || (c.resolveWith(f, [t]),
                t.fn.trigger && t(f).trigger("ready").off("ready"))
            }
        },
        ...
        isPlainObject: function(a) {
            if (!a || "object" !== t.type(a) || a.nodeType || t.isWindow(a))
                return !1;
            try {
                if (a.constructor && !r.call(a, "constructor") && !r.call(a.constructor.prototype, "isPrototypeOf"))
                    return !1
            } catch (c) {
                return !1
            }
        ...
        parseHTML: function(a, b, c) {
            ...
            var d = y.exec(a)
              , e = !c && [];
            return d ? [b.createElement(d[1])] : (d = t.buildFragment([a], b, e),
            e && t(e).remove(),
            t.merge([], d.childNodes))
        },
        parseJSON: function(b) {
            return a.JSON && a.JSON.parse ? a.JSON.parse(b) : null === b ? b : "string" == typeof b && (b = t.trim(b),
            b && z.test(b.replace(B, "@").replace(C, "]").replace(A, ""))) ? new Function("return " + b)() : (t.error("Invalid JSON: " + b),
            void 0)
        },
        parseXML: function(c) {
            var d, e;
        ...
        proxy: function(a, c) {
            ...
            c = a,
            a = f),
            t.isFunction(a) ? (d = o.call(arguments, 2),
            e = function() {
    ...
    t.ready.promise = function(b) {
        if (!c)
            ...
            "complete" === f.readyState)
                ...
                f.addEventListener("DOMContentLoaded", G, !1),
    ...
    t.support = function() {
        ...
        !c || !d || !c.length)
            return {};
        h = f.createElement("select"),
        j = h.appendChild(f.createElement("option")),
        ...
        b.input = "" === g.getAttribute("value"),
        g.value = "t",
        g.setAttribute("type", "radio"),
        b.radioValue = "t" === g.value,
        g.setAttribute("checked", "t"),
        ...
        return n.style.backgroundClip = "content-box",
        ...
        t(function() {
            ...
            g = n.getElementsByTagName("td"),
            g[0].style.cssText = "padding:0;margin:0;border:0;display:none",
            l = 0 === g[0].offsetHeight,
            g[0].style.display = "",
            g[1].style.display = "none",
            b.reliableHiddenOffsets = l && 0 === g[0].offsetHeight,
            n.innerHTML = "",
            ...
            typeof n.style.zoom !== e && (n.innerHTML = "",
            n.style.cssText = h + "width:1px;padding:1px;display:inline;zoom:1",
            b.inlineBlockNeedsLayout = 3 === n.offsetWidth,
            n.style.display = "block",
            n.innerHTML = "<div></div>",
            n.firstChild.style.width = "5px",
            b.shrinkWrapBlocks = 3 !== n.offsetWidth,
            b.inlineBlockNeedsLayout && (i.style.zoom = 1)),
            i.removeChild(c),
            c = n = g = d = null)
        }),
        c = h = i = j = d = g = null,
    ...
    t.extend({
        ...
        hasData: function(a) {
            return a = a.nodeType ? t.cache[a[t.expando]] : a[t.expando],
            !!a && !Q(a)
        },
        data: function(a, b, c) {
            return N(a, b, c)
    ...
    t.fn.extend({
        data: function(a, c) {
            ...
            if (a === b) {
                if (this.length && (h = t.data(f),
                1 === f.nodeType && !t._data(f, "parsedAttrs"))) {
                    for (d = f.attributes; g < d.length; g++)
                        e = d[g].name,
                        e.indexOf("data-") || (e = t.camelCase(e.slice(5)),
                        P(f, e, h[e]));
    ...
    t.extend({
        queue: function(a, b, c) {
            ...
            d = t._data(a, b),
            c && (!d || t.isArray(c) ? d = t._data(a, b, t.makeArray(c)) : d.push(c)),
            d || []) : void 0
        },
    ...
    t.fn.extend({
        queue: function(a, c) {
            ...
            a = "fx",
            d--),
            arguments.length < d ? t.queue(this[0], a) : c === b ? this : this.each(function() {
        ...
        delay: function(a, b) {
            return a = t.fx ? t.fx.speeds[a] || a : a,
            b = b || "fx",
    ...
    t.fn.extend({
        ...
        addClass: function(a) {
            ...
            if (i)
                for (b = (a || "").match(v) || []; h > g; g++)
                    if (c = this[g],
                    d = 1 === c.nodeType && (c.className ? (" " + c.className + " ").replace(T, " ") : " ")) {
                        for (f = 0; e = b[f++]; )
                            d.indexOf(" " + e + " ") < 0 && (d += e + " ");
        ...
        toggleClass: function(a, b) {
            ...
            return t.isFunction(a) ? this.each(function(c) {
                ...
                if ("string" === c)
                    for (var f, g = 0, h = t(this), i = b, j = a.match(v) || []; f = j[g++]; )
                        i = d ? i : !h.hasClass(f),
                        h[i ? "addClass" : "removeClass"](f);
                else
                    (c === e || "boolean" === c) && (this.className && t._data(this, "__className__", this.className),
                    this.className = this.className || a === !1 ? "" : t._data(this, "__className__") || "")
            })
        },
        hasClass: function(a) {
            for (var b = " " + a + " ", c = 0, d = this.length; d > c; c++)
                if (1 === this[c].nodeType && (" " + this[c].className + " ").replace(T, " ").indexOf(b) >= 0)
                    return !0;
            return !1
        },
        val: function(a) {
            ...
            {
                if (arguments.length)
                    return e = t.isFunction(a),
                    this.each(function(c) {
                        var f, g = t(this);
                        1 === this.nodeType && (f = e ? a.call(this, c, g.val()) : a,
                        null == f ? f = "" : "number" == typeof f ? f += "" : t.isArray(f) && (f = t.map(f, function(a) {
                            return null == a ? "" : a + ""
                        })),
                ...
                if (f)
                    return d = t.valHooks[f.type] || t.valHooks[f.nodeName.toLowerCase()],
    ...
    t.extend({
            ...
            select: {
                get: function(a) {
                    for (var b, c, d = a.options, e = a.selectedIndex, f = "select-one" === a.type || 0 > e, g = f ? null : [], h = f ? e + 1 : d.length, i = 0 > e ? h : f ? e : 0; h > i; i++)
                        if (c = d[i],
                        !(!c.selected && i !== e || (t.support.optDisabled ? c.disabled : null !== c.getAttribute("disabled")) || c.parentNode.disabled && t.nodeName(c.parentNode, "optgroup"))) {
                            if (b = t(c).val(),
                            f)
                                return b;
                            g.push(b)
        ...
        attr: function(a, c, d) {
            ...
            if (a && 3 !== i && 8 !== i && 2 !== i)
                return typeof a.getAttribute === e ? t.prop(a, c, d) : (g = 1 !== i || !t.isXMLDoc(a),
                g && (c = c.toLowerCase(),
                f = t.attrHooks[c] || (X.test(c) ? S : R)),
                d === b ? f && g && "get"in f && null !== (h = f.get(a, c)) ? h : (typeof a.getAttribute !== e && (h = a.getAttribute(c)),
        ...
        removeAttr: function(a, b) {
            ...
            if (f && 1 === a.nodeType)
                for (; c = f[e++]; )
                    d = t.propFix[c] || c,
                    X.test(c) ? !Z && Y.test(c) ? a[t.camelCase("default-" + c)] = a[d] = !1 : a[d] = !1 : t.attr(a, c, ""),
    ...
    $ && Z || (t.attrHooks.value = {
        ...
        set: function(a, b, c) {
            return t.nodeName(a, "input") ? (a.defaultValue = b,
            void 0) : R && R.set(a, b, c)
        }
    }),
    ...
    t.support.checkOn || t.each(["radio", "checkbox"], function() {
        t.valHooks[this] = {
            get: function(a) {
    ...
    t.event = {
        ...
        add: function(a, c, d, f, g) {
            ...
            if (s) {
                ...
                j = c.length; j--; )
                    ...
                    (o = i[p]) || (o = i[p] = [],
                    o.delegateCount = 0,
                    l.setup && l.setup.call(a, f, q, m) !== !1 || (a.addEventListener ? a.addEventListener(p, m, !1) : a.attachEvent && a.attachEvent("on" + p, m))),
        ...
        remove: function(a, b, c, d, e) {
            ...
            if (q && (k = q.events)) {
                ...
                t.isEmptyObject(k) && (delete q.handle,
                t._removeData(a, "events"))
            }
        },
        trigger: function(c, d, e, g) {
            var h, i, j, k, l, m, n, o = [e || f], p = r.call(c, "type") ? c.type : c, q = r.call(c, "namespace") ? c.namespace.split(".") : [];
            if (j = m = e = e || f,
            3 !== e.nodeType && 8 !== e.nodeType && !cb.test(p + t.event.triggered) && (p.indexOf(".") >= 0 && (q = p.split("."),
            p = q.shift(),
            q.sort()),
            i = p.indexOf(":") < 0 && "on" + p,
            c = c[t.expando] ? c : new t.Event(p,"object" == typeof c && c),
            c.isTrigger = !0,
            c.namespace = q.join("."),
            c.namespace_re = c.namespace ? new RegExp("(^|\\.)" + q.join("\\.(?:.*\\.|)") + "(\\.|$)") : null,
            c.result = b,
            c.target || (c.target = e),
            d = null == d ? [c] : t.makeArray(d, [c]),
            l = t.event.special[p] || {},
            g || !l.trigger || l.trigger.apply(e, d) !== !1)) {
                if (!g && !l.noBubble && !t.isWindow(e)) {
                    for (k = l.delegateType || p,
                    cb.test(k + p) || (j = j.parentNode); j; j = j.parentNode)
                        o.push(j),
                        m = j;
                ...
                for (n = 0; (j = o[n++]) && !c.isPropagationStopped(); )
                    ...
                    h = (t._data(j, "events") || {})[c.type] && t._data(j, "handle"),
                    h && h.apply(j, d),
                    h = i && j[i],
                    h && t.acceptData(j) && h.apply && h.apply(j, d) === !1 && c.preventDefault();
                if (c.type = p,
                !(g || c.isDefaultPrevented() || l._default && l._default.apply(e.ownerDocument, d) !== !1 || "click" === p && t.nodeName(e, "a") || !t.acceptData(e) || !i || !e[p] || t.isWindow(e))) {
                    m = e[i],
                    m && (e[i] = null),
                    t.event.triggered = p;
                    try {
                ...
                for (; j != this; j = j.parentNode || this)
                    if (1 === j.nodeType && (j.disabled !== !0 || "click" !== a.type)) {
                        ...
                        g = 0; i > g; g++)
                            e = c[g],
                            d = e.selector + " ",
                            f[d] === b && (f[d] = e.needsContext ? t(d, this).index(j) >= 0 : t.find(d, this, null, [j]).length),
                            f[d] && f.push(e);
                        f.length && h.push({
                            elem: j,
                            handlers: f
        ...
        fix: function(a) {
            ...
            for (h || (this.fixHooks[e] = h = bb.test(e) ? this.mouseHooks : ab.test(e) ? this.keyHooks : {}),
            d = h.props ? this.props.concat(h.props) : this.props,
            a = new t.Event(g),
            b = d.length; b--; )
                c = d[b],
                a[c] = g[c];
            return a.target || (a.target = g.srcElement || f),
        ...
        mouseHooks: {
            ...
            filter: function(a, c) {
                ...
                g = e.documentElement,
                d = e.body,
                a.pageX = c.clientX + (g && g.scrollLeft || d && d.scrollLeft || 0) - (g && g.clientLeft || d && d.clientLeft || 0),
        ...
        special: {
            ...
            focus: {
                trigger: function() {
                    if (this !== f.activeElement && this.focus)
                        try {
                            return this.focus(),
                            !1
                        } catch (a) {}
            ...
            blur: {
                trigger: function() {
                    return this === f.activeElement && this.blur ? (this.blur(),
                    !1) : void 0
                },
        ...
        simulate: function(a, b, c, d) {
            ...
            d ? t.event.trigger(e, null, b) : t.event.dispatch.call(b, e),
    ...
    : function(a, b, c) {
        var d = "on" + b;
        a.detachEvent && (typeof a[d] === e && (a[d] = null),
        a.detachEvent(d, c))
    }
    ,
    t.Event = function(a, b) {
        return this instanceof t.Event ? (a && a.type ? (this.originalEvent = a,
        this.type = a.type,
    ...
    t.each({
        ...
        t.event.special[a] = {
            ...
            handle: function(a) {
                ...
                return (!e || e !== d && !t.contains(d, e)) && (a.type = f.origType,
    ...
    t.support.submitBubbles || (t.event.special.submit = {
        ...
        postDispatch: function(a) {
            ...
            this.parentNode && !a.isTrigger && t.event.simulate("submit", this.parentNode, a, !0))
        },
        teardown: function() {
            return t.nodeName(this, "form") ? !1 : (t.event.remove(this, "._submit"),
            void 0)
        }
    }),
    t.support.changeBubbles || (t.event.special.change = {
        setup: function() {
            ...
            t.event.add(this, "click._change", function(a) {
                ...
                t.event.simulate("change", this, a, !0)
            })),
    ...
    t.fn.extend({
        ...
        off: function(a, c, d) {
            ...
            if (a && a.preventDefault && a.handleObj)
                ...
                t(a.delegateTarget).off(e.namespace ? e.origType + "." + e.namespace : e.origType, e.selector, e.handler),
                this;
            if ("object" == typeof a) {
                for (f in a)
                    this.off(f, c, a[f]);
        ...
        triggerHandler: function(a, b) {
            var c = this[0];
            return c ? t.event.trigger(a, b, c, !0) : void 0
        }
    }),
    function(a, b) {
        function db(a) {
        ...
        function hb(a, b, c, d) {
            ...
            if ((b ? b.ownerDocument || b : v) !== l && k(b),
            b = b || l,
            c = c || [],
            !a || "string" != typeof a)
                return c;
            ...
            if (!n && !d) {
                if (e = X.exec(a))
                    if (g = e[1]) {
                        ...
                        if (e[2])
                            return G.apply(c, H.call(b.getElementsByTagName(a), 0)),
                            c;
                        if ((g = e[3]) && w.getByClassName && b.getElementsByClassName)
                            return G.apply(c, H.call(b.getElementsByClassName(g), 0)),
                            c
                    }
                if (w.qsa && !o.test(a)) {
                    if (m = !0,
                    ...
                    1 === h && "object" !== b.nodeName.toLowerCase()) {
                        for (j = mb(a),
                        (m = b.getAttribute("id")) ? p = m.replace($, "\\$&") : b.setAttribute("id", p),
                        p = "[id='" + p + "'] ",
                        i = j.length; i--; )
                            j[i] = p + nb(j[i]);
                        q = V.test(a) && b.parentNode || b,
                        s = j.join(",")
                    }
                    if (s)
                        try {
                            return G.apply(c, H.call(q.querySelectorAll(s), 0)),
                            c
                        } catch (t) {} finally {
        ...
        function mb(a, b) {
            ...
            i = [],
            j = e.preFilter; h; ) {
                (!c || (d = Q.exec(h))) && (d && (h = h.slice(d[0].length) || h),
                i.push(f = [])),
                c = !1,
                (d = R.exec(h)) && (c = d.shift(),
                f.push({
                    value: c,
                    type: d[0].replace(P, " ")
                }),
                h = h.slice(c.length));
                for (g in e.filter)
                    !(d = U[g].exec(h)) || j[g] && !(d = j[g](d)) || (c = d.shift(),
                    f.push({
                        value: c,
                        type: g,
                        matches: d
        ...
        function rb(a, b, c, d, e, f) {
            ...
            fb(function(f, g, h, i) {
                ...
                if (f) {
                    ...
                    r = qb(r === g ? r.splice(o, r.length) : r),
        ...
        function sb(a) {
            for (var b, c, d, f = a.length, g = e.relative[a[0].type], h = g || e.relative[" "], i = g ? 1 : 0, k = ob(function(a) {
                ...
                if (c = e.relative[a[i].type])
                    ...
                    if (c = e.filter[a[i].type].apply(null, a[i].matches),
                    c[u]) {
            ...
            var c = 0
              ...
              , h = function(h, i, k, m, n) {
                ...
                f && t !== s) {
                    ...
                    G.apply(m, r),
                    v && !h && r.length > 0 && s + b.length > 1 && hb.uniqueSort(m)
                }
                return v && (x = z,
                j = w),
                u
        ...
        function vb(a, b, c, d) {
            ...
            if (!d && 1 === l.length) {
                ...
                g.length > 2 && "ID" === (i = g[0]).type && 9 === b.nodeType && !n && e.relative[g[1].type]) {
                    if (b = e.find.ID(i.matches[0].replace(ab, bb), b)[0],
                    !b)
                        return c;
                    a = a.slice(g.shift().value.length)
                }
                for (f = U.needsContext.test(a) ? 0 : g.length; f-- && (i = g[f],
                !e.relative[j = i.type]); )
                    if ((k = e.find[j]) && (d = k(i.matches[0].replace(ab, bb), V.test(g[0].type) && b.parentNode || b))) {
                        if (g.splice(f, 1),
                        a = d.length && nb(g),
                        !a)
                            return G.apply(c, H.call(d, 0)),
                            c;
                        break
                    }
            }
            return h(a, l)(d, b, n, c, V.test(a)),
            c
        }
        function wb() {}
        ...
        k = hb.setDocument = function(a) {
            ...
            return c !== l && 9 === c.nodeType && c.documentElement ? (l = c,
            m = c.documentElement,
            n = g(c),
            w.tagNameNoComments = gb(function(a) {
            ...
            e.find.CLASS = w.getByClassName && function(a, b) {
                return typeof b.getElementsByClassName === C || n ? void 0 : b.getElementsByClassName(a)
            }
            ,
            p = [],
            o = [":focus"],
            (w.qsa = db(c.querySelectorAll)) && (gb(function(a) {
                a.innerHTML = "<select><option selected=''></option></select>",
                a.querySelectorAll("[selected]").length || o.push("\\[" + J + "*(?:checked|disabled|ismap|multiple|readonly|selected|value)"),
                a.querySelectorAll(":checked").length || o.push(":checked")
            }),
            gb(function(a) {
                a.innerHTML = "<input type='hidden' i=''/>",
                a.querySelectorAll("[i^='']").length && o.push("[*^$]=" + J + "*(?:\"\"|'')"),
            ...
            (w.matchesSelector = db(q = m.matchesSelector || m.mozMatchesSelector || m.webkitMatchesSelector || m.oMatchesSelector || m.msMatchesSelector)) && gb(function(a) {
                w.disconnectedMatch = q.call(a, "div"),
                q.call(a, "[s!='']:x"),
                p.push("!=", O)
            }),
            o = new RegExp(o.join("|")),
            p = new RegExp(p.join("|")),
            r = db(m.contains) || m.compareDocumentPosition ? function(a, b) {
            ...
            s = m.compareDocumentPosition ? function(a, b) {
                var d;
                return a === b ? (i = !0,
                0) : (d = b.compareDocumentPosition && a.compareDocumentPosition && a.compareDocumentPosition(b)) ? 1 & d || a.parentNode && 11 === a.parentNode.nodeType ? a === c || r(v, a) ? -1 : b === c || r(v, b) ? 1 : 0 : 4 & d ? -1 : 1 : a.compareDocumentPosition ? -1 : 1
            }
            : function(a, b) {
        ...
        hb.matchesSelector = function(a, b) {
            ...
            b = b.replace(_, "='$1']"),
            !(!w.matchesSelector || n || p && p.test(b) || o.test(b)))
                try {
                    var c = q.call(a, b);
        ...
        hb.attr = function(a, b) {
            ...
            return (a.ownerDocument || a) !== l && k(a),
            n || (b = b.toLowerCase()),
            (c = e.attrHandle[b]) ? c(a) : n || w.attributes ? a.getAttribute(b) : ((c = a.getAttributeNode(b)) || a.getAttribute(b)) && a[b] === !0 ? b : c && c.specified ? c.value : null
        }
        ,
        hb.error = function(a) {
        ...
        e = hb.selectors = {
            ...
            preFilter: {
                ...
                CHILD: function(a) {
                    ...
                    "nth" === a[1].slice(0, 3) ? (a[3] || hb.error(a[0]),
                    a[4] = +(a[4] ? a[5] + (a[6] || 1) : 2 * ("even" === a[3] || "odd" === a[3])),
                    a[5] = +(a[7] + a[8] || "odd" === a[3])) : a[3] && hb.error(a[0]),
                    a
                },
                PSEUDO: function(a) {
                    var b, c = !a[5] && a[2];
            ...
            filter: {
                ...
                CHILD: function(a, b, c, d, e) {
                    ...
                    : function(b, c, i) {
                        ...
                        if (q) {
                            ...
                            } else if (s && (j = (b[u] || (b[u] = {}))[a]) && j[0] === x)
                                m = j[1];
                            else
                                for (; (l = ++n && l && l[p] || (m = n = 0) || o.pop()) && ((h ? l.nodeName.toLowerCase() !== r : 1 !== l.nodeType) || !++m || (s && ((l[u] || (l[u] = {}))[a] = [x, m]),
                                l !== b)); )
                                    ;
                            return m -= e,
                            m === d || 0 === m % d && m / d >= 0
                ...
                PSEUDO: function(a, b) {
                    ...
                    return d[u] ? d(b) : d.length > 1 ? (c = [a, a, "", b],
                    e.setFilters.hasOwnProperty(a.toLowerCase()) ? fb(function(a, c) {
            ...
            pseudos: {
                ...
                lang: fb(function(a) {
                    return T.test(a || "") || hb.error("unsupported lang: " + a),
                    a = a.replace(ab, bb).toLowerCase(),
                    function(b) {
                        var c;
                        do
                            if (c = n ? b.getAttribute("xml:lang") || b.getAttribute("lang") : b.lang)
        ...
        e.filters = wb.prototype = e.pseudos,
        e.setFilters = new wb,
        k(),
        hb.attr = t.attr,
        t.find = hb,
        ...
        t.unique = hb.uniqueSort,
        t.text = hb.getText,
        t.isXMLDoc = hb.isXML,
        t.contains = hb.contains
    }(a);
    var gb = /Until$/
    ...
    t.fn.extend({
        find: function(a) {
            ...
            if ("string" != typeof a)
                return d = this,
                this.pushStack(t(a).filter(function() {
                    for (b = 0; e > b; b++)
                        if (t.contains(d[b], this))
                            return !0
                }));
            for (c = [],
            b = 0; e > b; b++)
                t.find(a, this[b], c);
            return c = this.pushStack(e > 1 ? t.unique(c) : c),
    ...
    t.each({
        ...
        t.fn[a] = function(c, d) {
            ...
            return gb.test(a) || (d = c),
            d && "string" == typeof d && (e = t.filter(d, e)),
            e = this.length > 1 && !kb[a] ? t.unique(e) : e,
            this.length > 1 && hb.test(a) && (e = e.reverse()),
            this.pushStack(e)
        }
    }),
    t.extend({
        filter: function(a, b, c) {
            return c && (a = ":not(" + a + ")"),
            1 === b.length ? t.find.matchesSelector(b[0], a) ? [b[0]] : [] : t.find.matches(a, b)
        },
        dir: function(a, c, d) {
    ...
    t.fn.extend({
        ...
        remove: function(a, b) {
            for (var c, d = 0; null != (c = this[d]); d++)
                (!a || t.filter(a, [c]).length > 0) && (b || 1 !== c.nodeType || t.cleanData(Lb(c)),
                c.parentNode && (b && t.contains(c.ownerDocument, c) && Ib(Lb(c, "script")),
        ...
        html: function(a) {
            return t.access(this, function(a) {
                var c = this[0] || {}
                  ...
                  , e = this.length;
                if (a === b)
                    return 1 === c.nodeType ? c.innerHTML.replace(pb, "") : b;
                if (!("string" != typeof a || wb.test(a) || !t.support.htmlSerialize && qb.test(a) || !t.support.leadingWhitespace && rb.test(a) || Cb[(tb.exec(a) || ["", ""])[1].toLowerCase()])) {
                    ...
                    try {
                        for (; e > d; d++)
                            c = this[d] || {},
                            1 === c.nodeType && (t.cleanData(Lb(c, !1)),
                            c.innerHTML = a);
                        c = 0
                    } catch (f) {}
                }
        ...
        replaceWith: function(a) {
            var b = t.isFunction(a);
            return b || "string" == typeof a || (a = t(a).not(this).detach()),
        ...
        domManip: function(a, c, d) {
            ...
            if (q || !(1 >= l || "string" != typeof p || t.support.checkClone) && yb.test(p))
                return this.each(function(e) {
                    var f = n.eq(e);
                    q && (a[0] = p.call(this, e, c ? f.html() : b)),
                    f.domManip(a, c, d)
                });
            if (l && (j = t.buildFragment(a, this[0].ownerDocument, !1, this),
            e = j.firstChild,
            1 === j.childNodes.length && (j = e),
            e)) {
                for (c = c && t.nodeName(e, "tr"),
                h = t.map(Lb(j, "script"), Gb),
                g = h.length; l > k; k++)
                    f = j,
                    k !== o && (f = t.clone(f, !0, !0),
                    g && t.merge(h, Lb(f, "script"))),
                    d.call(c && t.nodeName(this[k], "table") ? Fb(this[k], "tbody") : this[k], f, k);
                if (g)
    ...
    t.extend({
        clone: function(a, b, c) {
            ...
            !(t.support.noCloneEvent && t.support.noCloneChecked || 1 !== a.nodeType && 11 !== a.nodeType || t.isXMLDoc(a)))
                for (d = Lb(f),
                h = Lb(a),
                g = 0; null != (e = h[g]); ++g)
                    d[g] && Kb(e, d[g]);
        ...
        buildFragment: function(a, b, c, d) {
            ...
            t.support.appendChecked || t.grep(Lb(n, "input"), Mb),
            o = 0; f = n[o++]; )
                if ((!d || -1 === t.inArray(f, d)) && (g = t.contains(f.ownerDocument, f),
        ...
        cleanData: function(a, b) {
            for (var c, d, f, g, h = 0, i = t.expando, j = t.cache, l = t.support.deleteExpando, m = t.event.special; null != (c = a[h]); h++)
                if ((b || t.acceptData(c)) && (f = c[i],
                g = f && j[f])) {
                    if (g.events)
                        for (d in g.events)
                            m[d] ? t.event.remove(c, d) : t.removeEvent(c, d, g.handle);
                    j[f] && (delete j[f],
                    l ? delete c[i] : typeof c.removeAttribute !== e ? c.removeAttribute(i) : c[i] = null,
                    k.push(f))
                }
        }
    });
    var Nb, Ob, Pb, Qb = /alpha\([^)]*\)/i, Rb = /opacity\s*=\s*([^)]*)/, Sb = /^(top|right|bottom|left)$/, Tb = /^(none|table(?!-c[ea]).+)/, Ub = /^margin/, Vb = new RegExp("^(" + u + ")(.*)$","i"), Wb = new RegExp("^(" + u + ")(?!px)[a-z%]+$","i"), Xb = new RegExp("^([+-])=(" + u + ")","i"), Yb = {
        BODY: "block"
    }, Zb = {
        position: "absolute",
        visibility: "hidden",
    ...
    t.extend({
        ...
        style: function(a, c, d, e) {
            if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
                ...
                if (c = t.cssProps[i] || (t.cssProps[i] = bc(j, i)),
                h = t.cssHooks[c] || t.cssHooks[i],
                d === b)
                    return h && "get"in h && (f = h.get(a, !1, e)) !== b ? f : j[c];
                if (g = typeof d,
                "string" === g && (f = Xb.exec(d)) && (d = (f[1] + 1) * f[2] + parseFloat(t.css(a, c)),
                g = "number"),
                !(null == d || "number" === g && isNaN(d) || ("number" !== g || t.cssNumber[i] || (d += "px"),
        ...
        css: function(a, c, d, e) {
            ...
            return c = t.cssProps[i] || (t.cssProps[i] = bc(a.style, i)),
            h = t.cssHooks[c] || t.cssHooks[i],
            h && "get"in h && (g = h.get(a, !0, d)),
            g === b && (g = Pb(a, c, e)),
            "normal" === g && c in $b && (g = $b[c]),
            "" === d || d ? (f = parseFloat(g),
            d === !0 || t.isNumeric(f) ? f || 0 : g) : g
        },
    ...
    t.each(["height", "width"], function(a, b) {
        t.cssHooks[b] = {
            ...
            set: function(a, c, d) {
                var e = d && Ob(a);
                return ec(a, c, d ? fc(a, b, d, t.support.boxSizing && "border-box" === t.css(a, "boxSizing", !1, e), e) : 0)
            }
        }
    }),
    t.support.opacity || (t.cssHooks.opacity = {
        ...
        set: function(a, b) {
            ...
            c.zoom = 1,
            (b >= 1 || "" === b) && "" === t.trim(f.replace(Qb, "")) && c.removeAttribute && (c.removeAttribute("filter"),
    ...
    t(function() {
        ...
        !t.support.pixelPosition && t.fn.position && t.each(["top", "left"], function(a, b) {
            t.cssHooks[b] = {
                get: function(a, c) {
                    return c ? (c = Pb(a, b),
                    Wb.test(c) ? t(a).position()[b] + "px" : c) : void 0
                }
            }
        })
    }),
    ...
    t.param = function(a, c) {
        ...
        if (c === b && (c = t.ajaxSettings && t.ajaxSettings.traditional),
        t.isArray(a) || a.jquery && !t.isPlainObject(a))
            t.each(a, function() {
    ...
    t.fn.load = function(a, c, d) {
        ...
        h.length > 0 && t.ajax({
            ...
            f = arguments,
            h.html(e ? t("<div>").append(t.parseHTML(a)).find(e) : a)
    ...
    t.extend({
        ...
        ajax: function(a, c) {
            function z(a, c, d, e) {
                ...
                d && (v = Ic(l, x, d)),
                a >= 200 && 300 > a || 304 === a ? (l.ifModified && (w = x.getResponseHeader("Last-Modified"),
                w && (t.lastModified[f] = w),
                w = x.getResponseHeader("etag"),
                w && (t.etag[f] = w)),
                204 === a ? (k = !0,
                y = "nocontent") : 304 === a ? (k = !0,
                y = "notmodified") : (k = Jc(l, v),
                y = k.state,
                r = k.data,
                s = k.error,
                k = !s)) : (s = y,
                ...
                x.status = a,
                x.statusText = (c || y) + "",
                k ? o.resolveWith(m, [r, y, x]) : o.rejectWith(m, [x, y, s]),
                x.statusCode(q),
                q = b,
                i && n.trigger(k ? "ajaxSuccess" : "ajaxError", [x, l, k ? r : s]),
                p.fireWith(m, [x, y]),
                i && (n.trigger("ajaxComplete", [x, l]),
            ...
            if (o.promise(x).complete = p.add,
            x.success = x.done,
            x.error = x.fail,
            l.url = ((a || l.url || qc) + "").replace(tc, "").replace(yc, pc[1] + "//"),
            l.type = c.method || c.type || l.method || l.type,
            l.dataTypes = t.trim(l.dataType || "*").toLowerCase().match(v) || [""],
            null == l.crossDomain && (d = zc.exec(l.url.toLowerCase()),
            ...
            2 === u)
                return x;
            i = l.global,
            i && 0 === t.active++ && t.event.trigger("ajaxStart"),
            l.type = l.type.toUpperCase(),
            l.hasContent = !xc.test(l.type),
            f = l.url,
            l.hasContent || (l.data && (f = l.url += (sc.test(f) ? "&" : "?") + l.data,
            delete l.data),
            l.cache === !1 && (l.url = uc.test(f) ? f.replace(uc, "$1_=" + rc++) : f + (sc.test(f) ? "&" : "?") + "_=" + rc++)),
            ...
            if (l.beforeSend && (l.beforeSend.call(m, x, l) === !1 || 2 === u))
                return x.abort();
            w = "abort";
            for (e in {
                success: 1,
    ...
    t.ajaxPrefilter("json jsonp", function(c, d, e) {
        ...
        c.converters["script json"] = function() {
            return h || t.error(f + " was not called"),
            h[0]
        }
        ,
        c.dataTypes[0] = "json",
    ...
    : Qc,
    Nc = t.ajaxSettings.xhr(),
    t.support.cors = !!Nc && "withCredentials"in Nc,
    Nc = t.support.ajax = !!Nc,
    Nc && t.ajaxTransport(function(c) {
        if (!c.crossDomain || t.support.cors) {
            ...
            return {
                send: function(e, f) {
                    ...
                    ,
                    c.async ? 4 === i.readyState ? setTimeout(d) : (g = ++Oc,
                    Pc && (Mc || (Mc = {},
                    t(a).unload(Pc)),
                    Mc[g] = d),
    ...
    var Sc, Tc, Uc = /^(?:toggle|show|hide)$/, Vc = new RegExp("^(?:([+-])=|)(" + u + ")([a-z%]*)$","i"), Wc = /queueHooks$/, Xc = [bd], Yc = {
        "*": [function(a, b) {
            var c, d, e = this.createTween(a, b), f = Vc.exec(b), g = e.cur(), h = +g || 0, i = 1, j = 20;
            if (f) {
                if (c = +f[2],
                d = f[3] || (t.cssNumber[a] ? "" : "px"),
                "px" !== d && h) {
                    h = t.css(e.elem, a, !0) || c || 1;
                    do
                        i = i || ".5",
                        h /= i,
                        t.style(e.elem, a, h + d);
    ...
    t.timers = [],
    t.fx = cd.prototype.init,
    t.fx.tick = function() {
        var a, c = t.timers, d = 0;
        for (Sc = t.now(); d < c.length; d++)
            a = c[d],
    ...
    t.fn.offset = function(a) {
        ...
        if (h)
            ...
            t.contains(c, g) ? (typeof g.getBoundingClientRect !== e && (f = g.getBoundingClientRect()),
            d = ed(h),
            {
    ...
    t.fn.extend({
        position: function() {
            if (this[0]) {
                ...
                b = this.offset(),
                t.nodeName(a[0], "html") || (c = a.offset()),
                c.top += t.css(a[0], "borderTopWidth", !0),
