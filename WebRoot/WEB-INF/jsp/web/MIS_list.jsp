...
<title>资管理财产品_资管理财产品咨询_资管理财产品预约 - 环成金服</title>
<meta name="keywords" content="资管理财产品,资管理财产品咨询,专业资管理财咨询,资管产品简介,资管理财收益,资管理财增信措施,资管理财产品风险">
<meta name="description" content="环成金服--一站式资管理财服务平台,专业理财顾问全天候24小时提供资管理财咨询;全面解读资管产品收益风险,免费咨询,可以依据客户偏好、为客户量身定制个性化资管理财产品。">
...
<body style=" background-color:#fcfcfc;">
  <script type="text/javascript">
	...
	<input type="hidden" id="WEBTYPE" value="3">
	<!--产品预约弹出框 -->
    ...
    <div id="common_currentlocation" class=" clearb">
        <div id="ctl00_ContentPlaceHolder1_Location_common_currentlocation_list" class=" w1200 mauto h48 lh48 fs14 c666666">
			...
			<div class=" fl ml10">&gt;</div><div class=" fl ml10"><a href="javascript:{location.reload();}">资管产品</a></div>
		</div>
    </div>   
     <!-- 产品搜索 -->
            ...
            <div class=" w1200 mauto">
                ...
                <div class="h44 bbs0068ff fs18">
                    ...
                    <div id="ctl00_ContentPlaceHolder1_trust_ProductCenter_Search_link" class=" h24">
						...
						<div class=" fwb w120 h24 fl brsdedede tac"><a href="javascript:{location.reload();}" class=" w120 h24 c3a8eff"  style="color: #f49703" >资管产品</a></div>
		...
		$(document).on('click', '.collection', function(e) {
			...
			if(imgname=="nocollection"){
 			...
 			$.ajax({
 				type:'POST',
 				url:'web/collectionProduct',
 				data:{'productId':productId,'collection':'no','phone':phone,'product_type':'zg','TYPE':'2'},
 				dataType:'json',
 				success:function(data){
 					$("#"+productId).prev().attr("src",path+"/collection.png");
 					$("#"+productId).html("取消收藏");
