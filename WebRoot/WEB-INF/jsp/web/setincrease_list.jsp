...
<link rel="Shortcut Icon" href="static/img/web/logo2.ico"> 
 <title>政府债理财产品_政府债理财产品咨询_政府债理财产品预约 - 环成金服</title>
<meta name="keywords" content="政府债理财产品,政府债理财产品咨询,专业政府债理财咨询,政府债产品简介,政府债理财收益,政府债理财增信措施,政府债理财产品风险">
<meta name="description" content="环成金服--一站式政府债理财服务平台,专业理财顾问全天候24小时提供政府债理财咨询;全面解读政府债产品收益风险,免费咨询,可以依据客户偏好、为客户量身定制个性化政府债理财产品。">
...
<!-- 合格投资者认定 -->
	...
	<input type="hidden" id="WEBTYPE" value="6">
    <div id="common_currentlocation" class=" clearb">
    	<div id="trust_index_banner" class="clearb" style="width:100%; height:350px; background:url(static/img/web/img_aboutus_banner_01.jpg) no-repeat top center;"></div>
        <div id="ctl00_ContentPlaceHolder1_Location_common_currentlocation_list" class=" w1200 mauto h48 lh48 fs14 c666666">
            ...
            <a href="javascript:{location.reload();}">政府债</a></div>
		</div>
    </div>
...
<script type="text/javascript">
	//分页查询
		function getList(currentPage){
			...
			$.ajax({
				type: "POST",
				url: '<%=basePath%>web/getSetincreaseList',
		    	data: data,
				dataType:'json',
