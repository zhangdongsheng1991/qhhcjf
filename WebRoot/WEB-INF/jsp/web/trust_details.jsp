  ...
  <script type="text/javascript">
    ...
    <div id="common_currentlocation" class=" clearb">
        <div id="ctl00_ContentPlaceHolder1_Location_common_currentlocation_list" class=" w1200 mauto h48 lh48 fs14 c666666">
        	<div class=" fl">当前位置：</div><div class=" fl ml10"><a href="s">首页</a></div><div class=" fl ml10">&gt;</div>
			<div class=" fl ml10"><a href="">固定收益</a></div>
			<div class=" fl ml10">&gt;</div><div class=" fl ml10"><a href="">信托产品</a></div>
		</div>
    </div>
...
<%--                 <!-- 开始循环 -->	
					<c:choose>
						<c:when test="${not empty trustDetails}">
								<c:forEach items="${trustDetails}" var="var" varStatus="vs"> --%>
                <div class=" fl">
                    <!-- 产品简介 -->
                    <div class=" w920">
                        <div id="ctl00_ContentPlaceHolder1_trust_productdetail_sketch_server" class="trust_productdetail_sketch pl20 pr20 w878 h330">
                        <div class=" h100 lh54 bbsdedede">
							<div class=" h32"></div>
							<div>
								<div class=" fl h40 ml5 mt6"><img src="static/img/logo1.jpg" width="40" height="40" border="0"></div>
								<div class="trust_productdetail_sketch_title h54 fl ml10 fs24 fwb">${trustDetails.PRODUCTNAME}</div>
							</div>
						</div>
                        
                        <div class=" w530 h85 ml120 mt15 bgf6f6f6 clearb">
                        <div class=" fl w530 h85">
                        <div class=" fl w530 h85">
                            <div class=" fl w180 h85 brddedede">
                            <div class=" tac fs16 h36 lh36 c999999">收益基准</div>
                            <div class=" tac fs28 h48 lh48 fwb cff6c00">${trustDetails.RETURNSBENCHMARK}<span class=" fs18 ml5"></span></div>
                            </div>
                            <div class=" fl w175 h85 brddedede">
                            <div class=" tac fs16 h36 lh36 c999999">投资起点</div>
                            <div class=" tac fs28 h48 lh48 fwb cff6c00">${trustDetails.INVESTMENTSTARTING}<span class=" fs18 ml5"></span></div>
                            </div>
                            <div class=" fl w170 h85">
                            <div class=" tac fs16 h36 lh36 c999999">产品期限</div>
                            <div class=" tac fs28 h48 lh48 fwb cff6c00">${trustDetails.PRODUCTDEADLINE}<span class=" fs18 ml5"></span></div>
                            </div>
                        </div>
                        </div>
                        </div>
                        <div class=" fs14 clearb">
                            ...
                            <div class=" ml40 h64 lh32 c666666">${trustDetails.PRODUCTREVIEWS}</div>
                        </div>
                        </div>
                    </div>
...
<td class=" bgffffff c666666" colspan="3"><div class=" tal ml40">${trustDetails.PRODUCTNAME}</div></td>
</tr>
<tr>
<td width="18%" class=" bgfafafa"><div class=" tar mr20">发行机构：</div></td>
<td width="32%" class=" bgffffff c666666"><div class=" tal ml40">${trustDetails.TRUSTTYPE}</div></td>
<td width="18%" class=" bgfafafa"><div class=" tar mr20">预计发行规模：</div></td>
<td width="32%" class=" bgffffff c666666"><div class=" tal ml40">${trustDetails.EXPECTISSUANCE}</div></td>
</tr>
<tr>
<td width="18%" class=" bgfafafa"><div class=" tar mr20">最低认购金额：</div></td>
<td width="32%" class=" bgffffff c666666"><div class=" tal ml40">${trustDetails.INVESTMENTSTARTING}</div></td>
<td width="18%" class=" bgfafafa"><div class=" tar mr20">利息分配：</div></td>
<td width="32%" class=" bgffffff c666666"><div class=" tal ml40">${trustDetails.CTDATE}每半年付息</div></td>
</tr>
<tr>
<td width="18%" class=" bgfafafa"><div class=" tar mr20">产品期限：</div></td>
<td width="32%" class=" bgffffff c666666"><div class=" tal ml40">${trustDetails.PRODUCTDEADLINE}</div></td>
...
<td width="18%" class=" bgfafafa"><div class=" tar mr20">收益基准：</div></td>
	<td width="32%" class=" bgffffff c666666">
		<div class=" tal ml40 lh28">
			${trustDetails.RETURNSBENCHMARK}
		</div>
	</td>
<td width="18%" class=" bgfafafa"><div class=" tar mr20">产品状态：</div></td>
<td width="32%" class=" bgffffff c666666"><div class=" tal ml40"><span class="cff6c00">${trustDetails.PRODUCTSTATUS}</span></div></td>
</tr>
</tbody></table>
</div>
...
<div class=" bg29a2e9">
                            ...
                            <div class=" w240 h40 ml20">
                              <div class=" fl w180 h40">
                                    <input  type="text"  value="请输入您的预约金额"  class=" trust_productdetail_input_bg"></div>
                            </div>
                    ...
                    <div class="fp-recommend">
                        ...
                        <ul id="ctl00_ContentPlaceHolder1_fp_recommend" class="financial-planner-list align-center">  <!-- 开始循环 -->	
							<c:choose>
    ...
    <div class=" w1200 mauto">
        ...
        <div class=" w1200 mauto">
            ...
            <div id="ctl00_ContentPlaceHolder1_production_recommend" class=" w1200">
             ...
             <!-- 开始循环 -->	
			<c:choose>
				<c:when test="${not empty solidPush}">
						<c:forEach items="${solidPush}" var="var" varStatus="vs">
				            <div class="trust_index_introduce_li fl">
				                ...
				                <div class=" h20"></div>
				                <a href="web/trustDetails?ID=${var.ID}"><div class=" w120 h32 lh32 mauto tac cffffff trust_index_introduce_btn">查看详情</div></a>
                    ...
                    <div id="lightbox-container-image-data-box">
                        ...
                        <div class="lightbox-container_box_right">
                            <a id="lightbox-secNav-btnClose">
                                <img src="static/img/lightbox-btn-close.png">
                            </a>
                        </div>
                    </div>
    ...
    <div style="background: #333333;">
        <div class=" w1200 mauto">
            ...
            <div><p class=" tac lh24 c999999" style=" font-size:12px;">
                ...
                <a target="_blank" href="" class=" ml10"><img src="static/img/img_sign_gonganbeian.png"><span class="ml5 c999999">粤公网安备 44030702000235号</span></a>
                <a id="___szfw_logo___" href="" target="_blank" class=" ml10"><img src="static/img/cert.png" border="0"></a>
		 </p></div>
