...
<link rel="Shortcut Icon" href="static/img/web/logo2.ico"> 
 <title>股权投资理财产品_股权投资理财产品咨询_股权投资理财产品预约 - 环成金服</title>
<meta name="keywords" content="股权投资理财产品,股权投资理财产品咨询,专业股权投资理财咨询,股权投资产品简介,股权投资理财收益,股权投资理财增信措施,股权投资理财产品风险">
<meta name="description" content="环成金服--一站式股权投资理财服务平台,专业理财顾问全天候24小时提供股权投资理财咨询;全面解读股权投资产品收益风险,免费咨询,可以依据客户偏好、为客户量身定制个性化股权投资理财产品。">
...
<!-- 合格投资者认定 -->
	...
	<input type="hidden" id="WEBTYPE" value="5">
    <div id="common_currentlocation" class=" clearb">
        <div id="ctl00_ContentPlaceHolder1_Location_common_currentlocation_list" class=" w1200 mauto h48 lh48 fs14 c666666">
            ...
            <a href="javascript:{location.reload();}">股权投资</a></div>
		</div>
    </div>
							...
							<c:when test="${not empty list}">
									<c:forEach items="${list}" var="var" varStatus="vs">
											<li class="pro_item">
						                        ...
						                        <div class="heading"><a href="web/goProductInfo?ID=${var.ID}&PRODUCTTYPE=2" target="_blank" class="title c000000" title="${var.PRODUCTREFERRED }">${var.PRODUCTREFERRED }</a>
...
<script type="text/javascript">
	//分页查询
		function getList(currentPage){
			...
			$.ajax({
				type: "POST",
				url: '<%=basePath%>web/getPrivateEquityList',
		    	data: data,
				dataType:'json',
