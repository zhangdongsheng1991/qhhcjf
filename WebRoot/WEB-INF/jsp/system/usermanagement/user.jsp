	...
	<body>
		...
		<div class="content_wrap">
			...
			<div class="right">
		 	 ...
		 	 <iframe scrolling="yes" style="border: 1px solid black;height:650px;width:200px;" ID="Frame1"  SRC="left.do" ></iframe>

		    <iframe ID="Frame2" SRC="left.action" allowTransparency="true" STYLE="background-color: green"> </iframe>
		
		    <iframe ID="Frame3" SRC="left.action"></iframe>
		
		    <iframe ID="Frame4" SRC="left.action" STYLE="background-color: green"> </iframe>
	</body>
</html>
