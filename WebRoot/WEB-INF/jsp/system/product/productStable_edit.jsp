...
<script type="text/javascript">
	...
	function save(){
		...
		if(!$("#INVESTMENTDIRECTION").val()){
			$("#INVESTMENTDIRECTION").tips({
				side:3,
	            msg:'请输入投资方向',
	            bg:'#AE81FF',
	            time:2
	        });
			$("#INVESTMENTDIRECTION").focus();
			return false;
		}
...
<body>
	<form action="productStable/${msg }.do" name="Form" id="Form" method="post">
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			...
			<tr>
				...
				<td><input type="text" name="INVESTMENTDIRECTION" id="INVESTMENTDIRECTION" value="${pd.INVESTMENTDIRECTION}"  placeholder="这里输入投资方向" title="投资方向"/></td>
			</tr>
			<tr>
