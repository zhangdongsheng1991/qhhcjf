...
<script type="text/javascript">
	...
	function save(){
		...
		if(!$("#RETURNSBENCHMARK").val()){
			$("#RETURNSBENCHMARK").tips({
				side:3,
	            msg:'请输入收益基准',
	            bg:'#AE81FF',
	            time:2
	        });
			$("#RETURNSBENCHMARK").focus();
			return false;
		}
	...
	<form action="product/${msg }.do" name="Form" id="Form" method="post">
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			...
			<tr>
				...
				<td><input type="text" name="RETURNSBENCHMARK" id="RETURNSBENCHMARK" value="${pd.RETURNSBENCHMARK}"  placeholder="这里输入收益基准" title="收益基准"/></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="THEISSUER" id="THEISSUER" value="${pd.THEISSUER}"  placeholder="这里输入发行机构" title="发行机构"/></td>
			</tr>
			<tr>
