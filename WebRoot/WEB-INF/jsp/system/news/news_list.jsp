			...
			<table id="table_report" class="table table-striped table-bordered table-hover">
				...
				<thead>
					<tr>
						...
						<th class="center">新闻图标</th>
						<th class="center">新闻来源</th>
						<th class="center">阅览数量</th>
						...
						<c:forEach items="${varList}" var="var" varStatus="vs">
							<tr>
								<td class='center' style="width: 30px;">${vs.index+1}</td>
										...
										<td><a href="${var.IMG}" target="_blank"><img style="height: 100px;width: 100px;" src="${var.IMG}"></a></td>
										<td class="center">${var.SOURCE}</td>
										<td class="center">${var.PVIEWS}</td>
